...
| `RETRY_BATCH_SIZE` | `50` | Größe des Sliding-Window/Buffers für Retry-Tasks (Backpressure). Unabhängig von `RETRY_CONCURRENCY` (Empfehlung: `RETRY_BATCH_SIZE` >= `RETRY_CONCURRENCY`). |
